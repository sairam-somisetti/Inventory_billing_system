...
# ---it's the file to store sales logs---
SALES_FILE = 'sales.csv'
#---it's the directory where all the bill files can be stored---
BILLS_DIR = 'bills'
...
def save_bill(bill_text, bill_data, format='txt'):
    if not os.path.exists(BILLS_DIR):
        ...
        #---the file name with time stamp for unique quality---
